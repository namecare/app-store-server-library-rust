...
pub struct AppStoreServerAPIClient<C, K, IS, B>
where
    C: AsRef<[u8]>,
    K: AsRef<str>,
    IS: AsRef<str>,
...
impl<C, K, IS, B> AppStoreServerAPIClient<C, K, IS, B>
where
    C: AsRef<[u8]>,
    K: AsRef<str>,
    IS: AsRef<str>,
    B: AsRef<str>,
{
    ...
    fn generate_token(&self) -> String {
        ...
        let key_id = self.key_id.as_ref().to_owned();

        let mut header = Header::new(Algorithm::ES256);
        header.kid = Some(key_id);

        let claims = Claims {
            bid: self.bundle_id.as_ref(),
            iss: self.issuer_id.as_ref(),
            aud: "appstoreconnect-v1",
            exp: future_time.timestamp(),
        };

        encode(&header, &claims, &EncodingKey::from_ec_pem(self.signing_key.as_ref()).unwrap())
            .unwrap()
    }
    ...
    fn build_request(&self, path: &str, method: Method) -> RequestBuilder {
        ...
        headers
            .append("Authorization", format!("Bearer {}", self.generate_token()).parse().unwrap());
        headers.append("Accept", "application/json".parse().unwrap());

        self.client.request(method, url).headers(headers)
    }

    async fn make_request_with_response_body<Res>(
        &self,
        request: RequestBuilder,
    ) -> Result<Res, APIException>
    where
    ...
    async fn make_request_without_response_body(
        &self,
        request: RequestBuilder,
    ) -> Result<(), APIException> {
    ...
    async fn make_request(
        &self,
        request: RequestBuilder,
    ) -> Result<reqwest::Response, APIException> {
    ...
    async fn make_request(
        &self,
        request: RequestBuilder,
    ) -> Result<Response<Vec<u8>>, APIException> {
    ...
    pub async fn get_status_of_subscription_renewal_date_extensions(
        ...
        let path =
            format!("/inApps/v1/subscriptions/extend/mass/{}/{}", product_id, request_identifier);
    ...
    pub async fn get_transaction_history_with_version(
        ...
        if let Some(subscription_group_ids) =
            &transaction_history_request.subscription_group_identifiers
        {
        ...
        if let Some(ownership_type) = &transaction_history_request.in_app_ownership_type {
            query_parameters
                .push(("inAppOwnershipType", ownership_type.raw_value().to_string().into()));
        }
    ...
    pub async fn get_transaction_info(
        &self,
        transaction_id: &str,
    ) -> Result<TransactionInfoResponse, APIException> {
    ...
    pub async fn look_up_order_id(
        &self,
        order_id: &str,
    ) -> Result<OrderLookupResponse, APIException> {
    ...
    pub async fn request_test_notification(
        &self,
    ) -> Result<SendTestNotificationResponse, APIException> {
...
mod tests {
    ...
    async fn test_extend_renewal_date_for_all_active_subscribers() {
        let client = app_store_server_api_client_with_body_from_file(
            ...
            Some(|req, body| {
                ...
                let decoded_json: HashMap<&str, Value> =
    ...
    async fn test_extend_subscription_renewal_date() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/extendSubscriptionRenewalDateResponse.json",
            StatusCode::OK,
            Some(|req, body| {
    ...
    async fn test_get_all_subscription_statuses() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/getAllSubscriptionStatusesResponse.json",
            StatusCode::OK,
            Some(|req, _body| {
    ...
    async fn test_get_refund_history() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/getRefundHistoryResponse.json",
            StatusCode::OK,
            Some(|req, _body| {
                assert_eq!(Method::GET, req.method());
                assert_eq!(
    ...
    async fn test_get_test_notification_status() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/getTestNotificationStatusResponse.json",
            StatusCode::OK,
            Some(|req, _body| {
                assert_eq!(Method::GET, req.method());
    ...
    async fn test_get_notification_history() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/getNotificationHistoryResponse.json",
            StatusCode::OK,
            Some(|req, body| {
                assert_eq!(Method::POST, req.method());
    ...
    async fn test_get_transaction_info() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/transactionInfoResponse.json",
            StatusCode::OK,
            Some(|req, _body| {
                assert_eq!(Method::GET, req.method());
                assert_eq!(
    ...
    async fn test_look_up_order_id() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/lookupOrderIdResponse.json",
            StatusCode::OK,
            Some(|req, _body| {
                assert_eq!(Method::GET, req.method());
                assert_eq!(
    ...
    async fn test_request_test_notification() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/requestTestNotificationResponse.json",
            StatusCode::OK,
            Some(|req, _body| {
                assert_eq!(Method::POST, req.method());
                assert_eq!(
    ...
    async fn test_send_consumption_data() {
        let client = app_store_server_api_client(
            ...
            Some(|req, body| {
                ...
                let decoded_json: HashMap<String, Value> =
                    serde_json::from_slice(body.unwrap()).unwrap();
        ...
        let client = app_store_server_api_client_with_body_from_file(
            ...
            Some(|req, _body| {
                ...
                let payload: HashMap<String, Value> =
                    serde_json::from_slice(&payload_data).unwrap();
    ...
    async fn test_api_error() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/apiException.json",
    ...
    async fn test_api_too_many_requests() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/apiTooManyRequestsException.json",
    ...
    async fn test_api_unknown_error() {
        let client = app_store_server_api_client_with_body_from_file(
            "assets/models/apiUnknownError.json",
    ...
    async fn test_decoding_with_unknown_enum_value() {
        ...
        let request = TransactionHistoryRequest {
            ...
            sort: Some(Order::Ascending),
            subscription_group_identifiers: vec![
                "sub_group_id".to_string(),
                "sub_group_id_2".to_string(),
            ]
            .into(),
    ...
    ) -> AppStoreServerAPIClient<Vec<u8>, String, String, String> {

...
use crate::models::lifetime_dollars_purchased::LifetimeDollarsPurchased;
use crate::models::lifetime_dollars_refunded::LifetimeDollarsRefunded;
use crate::models::platform::Platform;
use crate::models::play_time::PlayTime;
...
pub struct ConsumptionRequestV1 {
    ...
    pub delivery_status: Option<DeliveryStatusV1>,
    ...
    pub refund_preference: Option<RefundPreferenceV1>,
}
